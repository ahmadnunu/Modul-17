...
class EmployeesChart
{
    ...
    public function build(): \ArielMejiaDev\LarapexCharts\BarChart
    {
        ...
        return $this->chart->barChart()->setTitle('Posisi')->setSubtitle('Posisi dengan Jumlah Karyawan Terbanyak')->addData('Jumlah Karyawan', $employeesCount)->setXAxis($positionsLabels);
    }
}
